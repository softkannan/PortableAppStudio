...
{
    public partial class RegistryCleanupForceForm : INIValueEditForm
    {
        public RegistryCleanupForceForm()
        {
            InitializeComponent();
        ...
        {
            this.Text = string.Format("Registry Cleanup Force - {0}", this.Title);
