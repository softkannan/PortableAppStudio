...
{
    public partial class DirectoriesMoveForm : INIValueEditForm
    {
        public DirectoriesMoveForm()
        {
            InitializeComponent();
            this.Load += DirectoriesMoveForm_Load;

            bttnOk.Click += BttnOk_Click;

            helpTextBox.Rtf = PathManager.Init.GetHelpData("DirectoriesMove");
        ...
        private void DirectoriesMoveForm_Load(object sender, EventArgs e)
        {
            this.Text = string.Format("Directories Move - {0}", this.Title);
